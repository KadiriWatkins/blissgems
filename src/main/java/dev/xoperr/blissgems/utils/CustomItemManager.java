...
public class CustomItemManager {
    ...
    static {
        ...
        // Auratus Gem - T1 (placeholder; abilities are same as T2)
        registerItem("auratus_gem_t1", Material.ECHO_SHARD, 1009, "§e§lAURATUS GEM", List.of(
                "§f§lWIELD DIVINE CHAINS & AN UNBREAKABLE AEGIS",
                "",
                "§a🌟 §a§lPASSIVES",
                "§7- Divine Purity (clears debuffs on hit)",
                "§7- Angel's Grasp (5% pull nearby enemies)",
                "§7- Feathered Fall (70% fall damage reduction)",
                "§7- Hauling Strike (Haste + reverse KB when crouching)",
                "",
                "§e🌟 §e§lPOWERS",
                "§b§l⛓ VENERATED PERFORATORS",
                "§7Fire two chain hooks — grapple terrain or pull enemies.",
                "§7Sneak before impact for a ground slam + AOE.",
                "",
                "§b§l🛡 ECHOING AEGIS",
                "§7Parry window (~0.6s): reflects attacks & potions,",
                "§7drains attacker weapon durability.",
                "§7On success: heal 2-3 hearts + Speed III."
        ));
        registerItem("auratus_gem_t2", Material.ECHO_SHARD, 2009, "§e§lAURATUS GEM", List.of(
                "§f§lWIELD DIVINE CHAINS & AN UNBREAKABLE AEGIS",
                "§a§o(Pristine)",
                "",
                "§a🌟 §a§lPASSIVES",
                ...
                "§7Fire two chain hooks — grapple terrain or pull enemies.",
                "§7Sneak before impact for a ground slam + AOE.",
                "§7Use during Echoing Aegis to place a sky anchor.",
                "",
                "§b§l🛡 ECHOING AEGIS",
                "§7Parry window (~0.6s): reflects attacks & potions,",
                "§7drains attacker weapon durability.",
                "§7On success: heal 2-3 hearts + Speed III + Weaving."
        ));

        // Heretic Gem - T1 (placeholder; abilities are same as T2)
        registerItem("heretic_gem_t1", Material.ECHO_SHARD, 1010, "§4§lHERETIC GEM", List.of(
                "§f§lBLEED YOUR ENEMIES & LINK THEIR FATES",
                "",
                "§a🌟 §a§lPASSIVES",
                "§7- Auto-Crit (all hits critically strike, x1.5 damage)",
                "§7- Hemorrhage (Strength effect duration x4, up to 8min)",
                "",
                "§4🌟 §4§lPOWERS",
                "§b§l🩸 BLOODSAWS",
                "§7Fire 2 wide ricocheting projectiles that pass through enemies.",
                "§7Fire both within 0.5s for a Spore Fountain:",
                "§7nearby players bleed — amplifying all damage taken.",
                "",
                "§b§l⛓ BLOODLINKING",
                "§7Leap into the air and crash down dealing AOE damage.",
                "§7Hit players are bloodlinked — damage mirrors between them."
        ));
        registerItem("heretic_gem_t2", Material.ECHO_SHARD, 2010, "§4§lHERETIC GEM", List.of(
                "§f§lBLEED YOUR ENEMIES & LINK THEIR FATES",
                "§a§o(Pristine)",
                "",
                "§a🌟 §a§lPASSIVES",
